...
public interface Repository<ID, E extends Entity<ID>> {
    ...
    /**
     * Validates and saves an entity into the repository
     * @param entity to be saved
     * @return the entity if it already exists, null otherwise
     * @throws RepositoryException if the given entity is null
     * @throws domain.validators.ValidationException if the entity is not valid
     */
    E save(E entity);
     ...
     * @throws domain.validators.ValidationException if the given entity is not valid
     */
    E update(E entity);
}
